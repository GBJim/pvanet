...
#python tools/test_vatic.py  --data B1StreetDay --output video-coco80-20K --weights models/coco/all/coco80_iter_20000.caffemodel  --net #models/pvanet/lite/coco_test.prototxt --skip 1 --gpu 0 --class coco
...
python tools/test_vatic.py  --data $DATA--output video-all-coco80-$POSTFIX --weights models/coco/all/all-coco-80_iter_$ITERS.caffemodel  --net $TEST_PROTOTXT --skip 1 --gpu 0 --class $CLASS
