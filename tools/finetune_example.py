...
def prepare_data():
    ...
    #The devkit_path points to the path of VOC datset
    #pascal_voc should be specified by classes, data-split, and year
    ...
    vatic_names = ["YuDa","A1HighwayDay", "B2HighwayNight", "airport"]    
    ...
    datasets = vatics + [coco_train, coco_val] + [voc2007, voc2012]         
